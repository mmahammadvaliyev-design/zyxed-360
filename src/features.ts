...
export const FEATURES: FeatureFlag[] = [
  ...
  },
  {
    ...
    label: "RU/EN тур",
    description:
      "Переключатель языка (RU/EN) прямо в туре — для каждой панорамы и подписи перехода можно задать английский вариант в редакторе; если не задан, показывается русский. Пригодится для иностранных клиентов.",
    defaultOn: false,
  },
  {
    id: "projectBackup",
